...
def process_all_files(in_dir: Path, out_dir: Path) -> tuple[int, list[dict[str, Any]], list[dict[str, Any]]]:
...
def main() -> None:
    ...
    processed_files, empirical_rows, regression_rows = process_all_files(in_dir, out_dir)
