...
This script scans an input directory for `.xlsx` model files and writes one
output workbook containing:
...
Performance and safety rules implemented:
  ...
  - Processes both target sheets while the workbook is open.
