...
def set_formula2_r1c1(cell: xw.Range, formula_r1c1: str) -> None:
    # Prefer .formula2 as requested; COM fallbacks keep this robust.
    try:
...
def find_anchor(matrix: list[list[Any]], start_row: int, start_col: int, label: str = "max") -> tuple[int, int] | None:
