...
def parse_model_metadata(file_path: Path) -> dict[str, str]:
    ...
    period_match = re.search(r"\b(Early|Mid|Late)([A-Za-z]+)(\d{4})\b", stem, flags=re.IGNORECASE)
    if not period_match:
        ...
        for file_path in sorted(in_dir.iterdir()):
            ...
            try:
                ...
                if empirical_sheet is not None:
                    ...
                    print(f"  empirical skipped: missing sheet 'Empirical Model'")
                ...
                if regression_sheet is not None:
                    ...
                    print(f"  regression skipped: missing sheet 'Regression Model'")
